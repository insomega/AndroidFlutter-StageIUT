...
for /l %%i in (1, 1, 5) do (
	...
	set "PROJ_NAME=!App%%i_PROJ_NAME!"
	 ...
	 cmd /c ""E:\flutter_projects\portail_salarie\fnr.exe" --cl --dir "E:\flutter_projects\portail_salarie\android\app\src\main" --fileMask "AndroidManifest.xml" --excludeFileMask "*.dll, *.exe" --includeSubDirectories --find "Portail_Salarie" --replace "!PROJ_NAME!""
    ...
    move E:\flutter_projects\portail_salarie\build\app\outputs\apk\release\app-release.apk E:\flutter_projects\000_Release\!APP_NAME!.apk
	
	cmd /c ""E:\flutter_projects\portail_salarie\fnr.exe" --cl --dir "E:\flutter_projects\portail_salarie\android\app\src\main" --fileMask "AndroidManifest.xml" --excludeFileMask "*.dll, *.exe" --includeSubDirectories --find "!PROJ_NAME!" --replace "Portail_Salarie""
)
