...
import 'package:portail_salarie/GBSystem_X_Developpement/screens/ERROR/SSO_ERROR/GBSystem_error_sso_controller.dart';
import 'package:portail_salarie/_RessourceStrings/GBSystem_Application_Strings.dart';
import 'package:portail_salarie/_RessourceStrings/GBSystem_Server_Strings.dart';

class ErrorSSOPage extends StatelessWidget {
  ErrorSSOPage({
    super.key,
  });

  final m = Get.put<ErrorSSOController>(ErrorSSOController());
        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                    ...
                    child: GBSystem_TextHelper().largeText(
                      text: GbsSystemStrings.str_session_experer_sso.tr,
              ...
              Center(
                child: Lottie.asset(
                    GbsSystemServerStrings.str_error_sso_lottie_path,
                    // width: GBSystem_ScreenHelper.screenWidthPercentage(
                    //     context, 0.8),
