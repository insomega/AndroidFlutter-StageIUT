...
import 'package:portail_salarie/GBSystem_X_Developpement/models/APPLICATION_MODELS/GBSystem_position_with_error_model.dart';
  ...
  Future<DataServerModel?> getSiteS19Client(
    ...
    ResponseModel responseServer = await Api(context).get(
      ...
      url:
          ...
          // "https://192.168.1.60:8010/BMServerR.dll/BMDP81679E6763294DE3827D7D93EEE89436A?d-page=D1BAA8F26A9E418093FB0CDA98846062&SYSMENT_CODE=$clientName&SYSMENT_APPNAME=BMSERVER-MBLN",
