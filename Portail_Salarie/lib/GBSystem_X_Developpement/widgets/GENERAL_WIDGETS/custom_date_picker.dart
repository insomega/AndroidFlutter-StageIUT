...
class _CustomDatePickerState extends State<CustomDatePicker> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: widget.enabled ? null : () => _selectDate(context),
      child: Container(
        width: widget.width,
                ...
                widget.selectedDate != null
                    ? widget.addTime
                        ? "${widget.selectedDate?.day.toString().padLeft(2, '0')}/"
                            ...
                            "${widget.selectedDate?.hour.toString().padLeft(2, '0')}:"
                            "${widget.selectedDate?.minute.toString().padLeft(2, '0')}"
                        : "${widget.selectedDate?.day.toString().padLeft(2, '0')}/"
                            "${widget.selectedDate?.month.toString().padLeft(2, '0')}/"
                            "${widget.selectedDate?.year}"
                    : "",
