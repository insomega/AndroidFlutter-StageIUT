...
import 'package:portail_salarie/GBSystem_X_Developpement/widgets/HOME_WIDGET/VACATION_WIDGETS/VACATION_STATE_WIDGET/vacation_state_accepter_refuser_controller.dart';
...
class VacationStateAccepterRefuserWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final m = Get.put<VacationStateAccepterRefuserWidgetController>(
        VacationStateAccepterRefuserWidgetController(context));
    return m.vacationStateController.getAllVacationsOthers.value != null
        ? m.vacationStateController.getAllVacationsOthers.value!.isNotEmpty
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                if (snapshot.data != null && snapshot.data!.isNotEmpty) {
                  ...
                  return m.vacationStateController.getAllVacationsOthers
                                  .value !=
                              null &&
                          m.vacationStateController.getAllVacationsOthers.value!
                              .isNotEmpty
                      ? MainWidget(
        ...
        Container(
            ...
            child: Obx(() => ListView.builder(
                  ...
                  itemCount:
                      m.vacationStateController.getAllVacationsOthers.value !=
                              null
                          ? m.vacationStateController.getAllVacationsOthers
                              .value!.length
                          : 0,
...
class BtnAfficherHistorique extends StatelessWidget {
  const BtnAfficherHistorique({super.key, this.onTap});
      ...
      children: [
        Expanded(
          child: CustomButtonWithTrailling(
            ...
            textSize: 14,
            textBold: true,
            text: GbsSystemStrings.str_afficher_historique.tr,
            onTap: onTap,
          ),
        ),
      ],
