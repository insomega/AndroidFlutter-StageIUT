...
//
  ...
  static const str_new_version_available = 'New version available!';
  static const str_new_version_desc =
      'A new version of the app is available. To enjoy the latest features, please update the app by clicking "Update now".';
  static const str_try_later = 'Try Later';
  static const str_update_now = 'Update now';
  static const str_session_experer_sso = 'Session Expired due to SSO';
...
//Dialog
  ...
  static const String str_actions_offline =
      "Données en attente de synchronisation";
  static const String str_question_actions_offline =
      "Souhaitez-vous synchroniser vos données non enregistrées avec le serveur ?";

  static const String str_oui = "oui";
  static const String str_non = "non";
...
//// Home Page
  ...
  static const String str_partager = "Partager";
...
// formulaire screen
  ...
  // qcm widget
  static const String str_operation_effectuer = "Opération effectuée";
