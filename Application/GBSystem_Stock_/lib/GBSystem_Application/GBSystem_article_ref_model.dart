...
class GbsystemArticleRefModel {
  ...
  static GbsystemArticleRefModel fromJson(json) {
    ...
    if (json["ARTREF_START_DATE"].toString().isNotEmpty) {
      ARTREF_START_DATE =
          DateFormat(detecteDateFormat(json["ARTREF_START_DATE"]))
              .parse(json["ARTREF_START_DATE"]);
    }
    if (json["ARTREF_END_DATE"].toString().isNotEmpty) {
      ARTREF_END_DATE = DateFormat(detecteDateFormat(json["ARTREF_END_DATE"]))
          .parse(json["ARTREF_END_DATE"]);
    }
  ...
  static List<GbsystemArticleRefModel> convertDynamictoListArticles(
