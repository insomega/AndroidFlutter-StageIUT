...
class GbsystemListEvaluationNonTerminerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final GbsystemListEvaluationNonTerminerController m = Get.put(GbsystemListEvaluationNonTerminerController(context: context));
            ...
            child: ImageFiltered(
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  title: const Text(GBSystem_Application_Strings.str_selectioner_salarie, style: TextStyle(color: Colors.white), maxLines: 1),
                  leading: InkWell(
                    onTap: () {
                      Get.back();
                    },
                  ...
                  children: [
                    ...
                    Expanded(
                      child: m.usedListSalaries().isNotEmpty
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: EvaluationNonTerminerWidget(
                                      onTap: () async {
                                        m.usedListSalaries()[index].LIEINSPQSNR_NOTATION_TYPE == GBSystem_Application_Strings.str_selected_type_questionnaire_qcm ? m.getQCMData(eval: m.usedListSalaries()[index]) : m.getFormulaireData(eval: m.usedListSalaries()[index]);
                                      },
                                      evaluationNonTerminer: m.usedListSalaries()[index],
                                      imageSalarie: null,
                                    ),
                                  );
                                },
                          ...
                          : SingleChildScrollView(child: EmptyDataWidget(heightLottie: GBSystem_ScreenHelper.screenWidthPercentage(context, 0.8))),
                    ),
                  ],
                ),
              ),
