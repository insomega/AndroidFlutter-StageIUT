...
import 'GBSystem_question_type_with_his_questions_model.dart';
...
class FormulaireController extends GetxController {
  ...
  set setNewQuestionTypeWithHisQuestions(QuestionTypeWithHisQuestionsModel questionTypeWithQuestions) {
  ...
  set setAllQuestionTypeWithHisQuestionsModel(List<QuestionTypeWithHisQuestionsModel> listQuestionTypeWithQuestions) {
  ...
  List<QuestionTypeWithHisQuestionsModel>? get getAllQuestionTypeWithHisQuestionsModel => _listQuestionTypeWithQuestions;
  List<QuestionTypeModel>? get getAllQuestionType => _listQuestionType;

  String? get get_LIEINSPSVR_IDF => _value_LIEINSPSVR_IDF;

  bool isLastQuestionTypeWithHisQuestions(QuestionTypeWithHisQuestionsModel QuestionTypeWithHisQuestionsModel) {
    int? indexOfElement = _listQuestionTypeWithQuestions?.indexOf(QuestionTypeWithHisQuestionsModel);
  ...
  bool buttonSuivantVisibility(QuestionTypeWithHisQuestionsModel questionTypeWithHisQuestionsModel, QuestionModel question) {
    //test if we are in last qst type
    bool isLastQstType = (_listQuestionType?.indexOf(questionTypeWithHisQuestionsModel.questionType) == _listQuestionType?.length);

    bool isLastQuestion = (question == questionTypeWithHisQuestionsModel.questions.length);
