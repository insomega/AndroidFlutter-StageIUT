...
class GBSystem_ManageCatchErrors {
  ...
  Future<void> catchErrors(BuildContext context, {required String page, required String method, required String message}) async {
    await GBSystem_AuthService(context).ManageCatchErrorsServer(page: page, functionName: method, msg: message).then((value) {
      // showErrorDialog(context, "Planter : page : $page | method : $method | message : $message ");
    });
