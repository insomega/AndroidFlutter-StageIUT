...
class GBSystemEvaluationSurSiteController extends GetxController {
  ...
  Rx<QuestionnaireModel?> _selectedQuestionnaire = Rx<QuestionnaireModel?>(null);
  Rx<TypeQuestionnaireModel?> _selectedTypeQuestionnaire = Rx<TypeQuestionnaireModel?>(null);
  ...
  QuestionnaireModel? get getSelectedQuestionnaire => _selectedQuestionnaire.value;
  ...
  TypeQuestionnaireModel? get getSelectedTypeQuestionnaire => _selectedTypeQuestionnaire.value;
  ...
  List<TypeQuestionnaireModel>? get getAllTypeQuestionnaires => _allTypeQuestionnaire;
}
