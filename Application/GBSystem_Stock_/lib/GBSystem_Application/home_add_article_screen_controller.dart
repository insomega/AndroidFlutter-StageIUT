...
import 'package:gbsystem_root/custom_date_picker.dart' show CustomDatePickerFrench;
...
import 'package:gbsystem_stock/GBSystem_Application/select_item_color_screen.dart';
import 'package:gbsystem_stock/GBSystem_Application/select_item_enterpot_screen.dart';
import 'package:gbsystem_stock/GBSystem_Application/select_item_fournisseur_screen.dart';
                            ...
                            InkWell(
                              onTap: () async {
                                await GBSystem_AuthService(context).getAllFournisseur().then((value) {
                                  if (value != null) {
                                    fournisseurController.setAllFournisseur = value.cast<GbsystemFournisseurModel>();
                                ...
                                InkWell(
                                  onTap: () async {
                                    await GBSystem_AuthService(context).getAllColors().then((value) {
                                      if (value != null) {
                                        colorsController.setAllColors = value.cast<GbsystemColorModel>();
                                ...
                                .then((value) {
                                  ...
                                  if (value != null) {
                                    for (var element in value) {
                                      catalogueController.addNewCatalogue(element);
                                    }
                            ...
                            Stack(
                              children: [
                                InkWell(
                                  ...
                                  child: Obx(() => CustomTextField(borderColor: Colors.black, labelColor: Colors.black, color: Colors.black, colorLabel: true, controller: controllerCouleur.value, enabled: false, text: GBSystem_Application_Strings.str_select_couleurs)),
                                ),
                                Positioned(
                                  top: 8,
                                  right: 3,
                          ...
                          //         .value.text.isNotEmpty)
                            ...
                            await GBSystem_AuthService(context)
                                ...
                                .then((value) {
                                  ...
                                  if (value != null) {
                                    catalogueController.updateCatalogue(catalogue, (value as GbsystemCatalogueModel));
                                    updateUI();
                                    if (Get.isDialogOpen == true) {
                                      Get.back();
                                    }
