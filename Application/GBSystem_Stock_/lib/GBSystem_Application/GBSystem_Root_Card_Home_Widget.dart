...
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_salarie_planning_model.dart';
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_site_gestion_stock_model.dart';
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_site_planning_model.dart';
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_vacation_model.dart';
import 'package:gbsystem_translations/GBSystem_Application_Strings.dart';
import 'package:get/get.dart';

class GBSystem_Root_CardViewHome_Widget_Generique extends Card {
  const GBSystem_Root_CardViewHome_Widget_Generique({super.key, this.onSearchTap, required this.title, required this.opt1, required this.opt2, required this.opt3, required this.opt4});
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 2),
                Divider(indent: 0, color: Colors.transparent, thickness: 1),
                Padding(
            ...
            child: Stack(
              ...
              children: [
                PageView(
                  ...
                  children: [
                    PageSalarie1(onNbr1Tap: widget.onNbr1Tap, onNbr2Tap: widget.onNbr2Tap, onNbr3Tap: widget.onNbr3Tap, salarieGestionStockModel: widget.salarieGestionStockModel!),
                    // PageSalarie2(
                  ...
                  child: Positioned(
                    ...
                    child: Obx(() {
                      return DotsIndicator(
                        decorator: const DotsDecorator(color: Colors.black, activeColor: GBSystem_Application_Strings.str_primary_color, activeSize: Size(12, 12), size: Size(12, 12)),
                        dotsCount: 2,
                        onTap: (position) {
        ...
        Visibility(
          ...
          child: widget.isSearch
              ? Positioned(
                  top: 8,
                  right: 8,
                  child: InkWell(onTap: widget.onTap, child: Icon(CupertinoIcons.search)),
                )
              : Positioned(
                  top: 8,
                  right: 8,
                  child: InkWell(onTap: widget.onDeleteTap, child: Icon(CupertinoIcons.delete)),
                ),
        ),
      ],
    );
      ...
      children: [
                ...
                child: imageSalarie != null
                    ? Image.memory(
                        ...
                        errorBuilder: (context, error, stackTrace) => Container(
                          ...
                          child: Center(
                            child: GBSystem_TextHelper().largeText(text: "${salarieGestionStockModel.salarieModel.SVR_LIB.substring(0, 1).toUpperCase()}${salarieGestionStockModel.salarieModel.SVR_LIB.substring(1, 2).toUpperCase()}", textColor: Colors.white),
                          ),
                        ),
                      )
                    : Container(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: GBSystem_TextHelper().normalText(textAlign: TextAlign.start, textColor: Colors.black, text: salarieGestionStockModel.salarieModel.SVR_LIB, maxLines: 2, fontWeight: FontWeight.bold),
              ),
              Transform.translate(
                  ...
                  children: [
                    CupertinoButton(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Icon(CupertinoIcons.phone_circle_fill, color: Colors.black),
                          const SizedBox(width: 5),
                          SizedBox(
                            width: 80,
                            child: GBSystem_TextHelper().smallText(
                              text: salarieGestionStockModel.salarieModel.SVR_TELPOR != null && salarieGestionStockModel.salarieModel.SVR_TELPOR!.isNotEmpty && salarieGestionStockModel.salarieModel.SVR_TELPOR != " " ? salarieGestionStockModel.salarieModel.SVR_TELPOR! : "",
                    ...
                    CupertinoButton(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Icon(CupertinoIcons.phone_fill, color: Colors.black),
                          const SizedBox(width: 5),
                          SizedBox(
                            width: 80,
                            child: GBSystem_TextHelper().smallText(
                              text: salarieGestionStockModel.salarieModel.SVR_TELPH1 != null && salarieGestionStockModel.salarieModel.SVR_TELPH1!.isNotEmpty && salarieGestionStockModel.salarieModel.SVR_TELPH1 != " " ? salarieGestionStockModel.salarieModel.SVR_TELPH1! : "",
                              fontWeight: FontWeight.w500,
                              maxLines: 2,
                              textColor: Colors.black,
                            ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            top: 0,
                            right: 0,
                            child: GBSystem_TextHelper().superSmallText(text: "2", textColor: Colors.black, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                      ...
                      SizedBox(
                        width: 90,
                        child: GBSystem_TextHelper().smallText(
                          text: salarieGestionStockModel.salarieModel.SVR_TELPH != null && salarieGestionStockModel.salarieModel.SVR_TELPH!.isNotEmpty && salarieGestionStockModel.salarieModel.SVR_TELPH != " " ? salarieGestionStockModel.salarieModel.SVR_TELPH! : "",
                          fontWeight: FontWeight.w500,
                          maxLines: 2,
                          textColor: Colors.black,
                        ),
            ...
            child: salarie != null
                ? Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      Divider(color: Colors.transparent, indent: 0, thickness: 1),
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 10),
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                ButtonEntrerSortieWithIconAndText(
                                  text: GBSystem_Application_Strings.str_appeler,
                                  number: null,
                                  verPadd: 8,
                                  horPadd: 5,
                ...
                : Row(
                    ...
                    children: [
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [GBSystem_TextHelper().smallText(text: GBSystem_Application_Strings.str_no_item)],
                      ),
                    ],
                  ),
          ),
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: site != null
                ...
                : Container(
                    height: 150,
                    child: Center(child: GBSystem_TextHelper().smallText(text: GBSystem_Application_Strings.str_aucune_agence_selectionner)),
                  ),
          ),
        ),
        Positioned(
...
class GBSystem_Root_CardViewHome_Widget_Salarie_Gestion_Stock extends Card {
  const GBSystem_Root_CardViewHome_Widget_Salarie_Gestion_Stock({super.key, required this.salarie, this.onSearchTap, required this.title, this.onNFCTap});
      ...
      children: [
        InkWell(
          ...
          child: Container(
            ...
            child: salarie != null
                ...
                : Container(
                    height: 150,
                    child: Center(child: GBSystem_TextHelper().smallText(text: GBSystem_Application_Strings.str_aucune_salarie_selectionner)),
                  ),
          ),
        ),
        Positioned(
        ...
        Visibility(
          ...
          child: Positioned(
            ...
            child: InkWell(
              onTap: onNFCTap,
              child: const Icon(Icons.nfc, color: Colors.black),
            ),
          ),
        ),
      ],
...
class GBSystem_Root_CardView_Fournisseur_Widget extends StatelessWidget {
  const GBSystem_Root_CardView_Fournisseur_Widget({super.key, required this.fournisseur, this.onTap, this.tileColor});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        onTap: onTap,
        isThreeLine: true,
        title: Text(fournisseur.FOU_LIB, maxLines: 2),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(fournisseur.FOU_TEL, maxLines: 2),
            Text(fournisseur.FOU_ADR1, maxLines: 2),
            Text(fournisseur.FOU_TELPOR, maxLines: 2),
...
class GBSystem_Root_CardView_Color_Widget extends StatelessWidget {
  const GBSystem_Root_CardView_Color_Widget({super.key, required this.color, this.onTap, this.tileColor});
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color:
            // tileColor
            Color(int.parse('0xFF${color.CLR_CODE_colorweb.replaceAll(r"#", "").replaceAll(r"$", "")}')),
      ),
      child: ListTile(
        onTap: onTap,
        isThreeLine: true,
        title: Text(color.CLR_LIB, maxLines: 2),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(color.CLRCAT_LIB, maxLines: 2),
            Text(color.DGRP_LIB, maxLines: 2),
            Text(color.CLR_CAT, maxLines: 2),
...
class GBSystem_Root_CardView_Enterpot_Widget extends StatelessWidget {
  const GBSystem_Root_CardView_Enterpot_Widget({super.key, required this.enterpot, this.onTap, this.tileColor});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        onTap: onTap,
        isThreeLine: true,
        title: Text(enterpot.ENTR_LIB, maxLines: 2),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(enterpot.ENTR_EMAIL, maxLines: 2),
            Text(enterpot.ENTR_TELPH, maxLines: 2),
            Text(enterpot.VIL_LIB, maxLines: 2),
...
class GBSystem_Root_CardView_Article_Widget extends StatelessWidget {
  const GBSystem_Root_CardView_Article_Widget({super.key, required this.article, this.onTap, this.tileColor});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        onTap: onTap,
        isThreeLine: true,
        title: Text(article.ARTREF_LIB, maxLines: 2),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(article.ARTCAT_LIB, maxLines: 2),
            Text(article.ARTREF_DUREE_VIE_TYPE, maxLines: 2),
            Text(article.ARTREF_DUREE_VIE_UNIT, maxLines: 2),
