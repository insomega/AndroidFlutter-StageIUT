...
import 'package:gbsystem_stock/GBSystem_Application/select_item_article_screen_controller.dart';
import 'package:gbsystem_translations/GBSystem_Application_Strings.dart';
import 'package:get/get.dart';

class GBSystem_SelectItemArticleScreen extends StatelessWidget {
  const GBSystem_SelectItemArticleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final GBSystemSelectItemArticleScreenController m = Get.put(GBSystemSelectItemArticleScreenController(context: context));
              ...
              child: Column(
                children: [
                  SearchBar(
                    ...
                    hintText: GBSystem_Application_Strings.str_rechercher.tr,
                                  ...
                                  itemBuilder: (context, index) {
                                    return Padding(
                                      ...
                                      child: GBSystem_Root_CardViewWidgetGenerique(
                                        ...
                                        onTap: () {
                                          m.selectItemSiteFunction(selectedArt: m.filtredArticles[index]);

                                          // controllerTxtField.text =
                                          //     m.filtredArticles[index].ARTREF_LIB;
                                        },
                                        title: m.filtredArticles[index].ARTREF_LIB,
                                        optStr1: m.filtredArticles[index].ARTCAT_LIB,
                                        optStr2: m.filtredArticles[index].ARTREF_DUREE_VIE_TYPE,
                                        optStr3: m.filtredArticles[index].ARTREF_DUREE_VIE_UNIT,
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: GBSystem_Root_CardViewWidgetGenerique(
                                  tileColor: index % 2 == 0 ? Colors.grey.withOpacity(0.2) : Colors.white,
                                  onTap: () {
                                    m.selectItemSiteFunction(selectedArt: m.articles[index]);
                                    // controllerTxtField.text =
                                  ...
                                  optStr2: m.articles[index].ARTREF_DUREE_VIE_TYPE,
                                  optStr3: m.articles[index].ARTREF_DUREE_VIE_UNIT,
