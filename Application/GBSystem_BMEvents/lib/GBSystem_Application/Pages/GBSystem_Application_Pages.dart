...
import '../GBSystem_MainForm_BMEvents_Bindng.dart';
import '../GBSystem_MainForm_BMEvents_View.dart';
...
class GBSystem_Application_Pages {
  static final pages = [
    ...
    GetPage(name: GBSystem_Application_Routes.mainAppView, page: () => GBSystem_MainForm_BMEvents_View(), binding: GBSystem_MainForm_BMEvents_Binding()),
