...
class GBSystem_MainForm_PS1_Controller extends GBSystem_Root_MainForm_Controller {
  ...
  Future<void> _initializeData_For_First_VAcation() async {
    try {} catch (e) {
      GBSystem_Add_LogEvent(message: e.toString(), method: "_initializeData_For_First_VAcation", page: "GBSystem_MainForm_PS1_Controller");
    }
  }
  ...
  Future<void> _initializeData() async {
    try {
      ...
      GBSystem_Add_LogEvent(message: e.toString(), method: "_initializeData", page: "GBSystem_MainForm_PS1_Controller");
    } finally {
