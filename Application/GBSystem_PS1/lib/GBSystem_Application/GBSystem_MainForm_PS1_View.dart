...
class GBSystem_MainForm_PS1_View extends GBSystem_Root_MainForm_View<GBSystem_MainForm_PS1_Controller> {
  GBSystem_MainForm_PS1_View({Key? key}) : super(key: key);

  @override
  final controller = Get.put(GBSystem_MainForm_PS1_Controller());
...
// class GBSystem_MainForm_PS1_View extends GetView<GBSystem_MainForm_PS1_Controller> {
//   @override
