...
class GBSystem_PS1_Initializer extends GBSystem_AppInitializer {
  GBSystem_PS1_Initializer() {
    // TODO: implement
  }
  ...
  static Future<bool> initialize() async {
    ...
    GBSystem_Application_Params_Manager.initialize(GBSystem_PS1_Application_Params());
