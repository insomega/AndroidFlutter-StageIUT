...
class GBSystemSelectItemSalarieGestionStockController extends GetxController {
  ...
  RxList<SalarieGestionStockModel> salaries =
      RxList<SalarieGestionStockModel>([]);
  RxList<SalarieGestionStockModel> filtredsalaries =
      RxList<SalarieGestionStockModel>([]);
  ...
  Future selectItemVacationFunction(
      {required SalarieGestionStockModel selectedSalarie}) async {
