...
import 'package:gbs_new_project/GBSystem_X_Developpement/screens/HOME/select_item_color/select_item_color_screen_controller.dart';
...
class GBSystem_SelectItemColorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final GBSystemSelectItemColorScreenController m =
        Get.put(GBSystemSelectItemColorScreenController(context: context));
                            ...
                            ? Expanded(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    late Color color;
                                    final hexColor = m
                                        .filtredColors[index].CLR_CODE_colorweb
                                        .replaceAll(r"#", "")
                                        .replaceAll(r"$", "")
                                        .replaceAll(r"#", "");
                                    if (int.tryParse(
                                      ...
                                      child:
                                        ...
                                        onTap: () {
                                          m.selectItemSiteFunction(
                                              selectedColor:
                                                  m.filtredColors[index]);

                                          controllerTxtField.text =
                                              m.filtredColors[index].CLR_LIB;

                                          colorField = Color(int.parse(
                                            '0xFF${m.filtredColors[index].CLR_CODE_colorweb.replaceAll(r"#", "").replaceAll(r"$", "")}',
                                          ));
                                          updateUI();
                                        },
                                        title: m.filtredColors[index].CLR_LIB,
                                        optStr1:
                                            m.filtredColors[index].CLRCAT_LIB,
                                        optStr2:
                                            m.filtredColors[index].DGRP_LIB,
                            ...
                            ? Expanded(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    late Color color;
                                    final hexColor = m
                                        .colors[index].CLR_CODE_colorweb
                                        .replaceAll(r"#", "")
                                        .replaceAll(r"$", "")
                                        .replaceAll(r"#", "");
                                    if (int.tryParse(
                                    ...
                                    return Padding(
                                      ...
                                      child:
                                        ...
                                        circleColor: color,
                                        showCircleBorder: m
                                                .colors[index].CLR_LIB
                                                .toLowerCase()
                                                .contains("blanc")
                                            ? true
                                            : false,
                                        textCircleColor: m.colors[index].CLR_LIB
                                                .toLowerCase()
                                                .contains("blanc")
                                            ? Colors.black
                                            : null,
                                        ...
                                        onTap: () {
                                          m.selectItemSiteFunction(
                                              selectedColor: m.colors[index]);
                                          controllerTxtField.text =
                                              m.colors[index].CLR_LIB;
                                          colorField = Color(int.parse(
                                            '0xFF${m.colors[index].CLR_CODE_colorweb.replaceAll(r"#", "").replaceAll(r"$", "")}',
                                          ));
                                          updateUI();
