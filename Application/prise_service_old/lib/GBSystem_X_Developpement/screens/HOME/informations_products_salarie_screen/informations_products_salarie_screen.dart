...
import 'package:gbs_new_project/GBSystem_X_Developpement/screens/HOME/informations_products_salarie_screen/informations_products_salarie_screen_controller.dart';
import 'package:gbs_new_project/GBSystem_X_Developpement/screens/HOME/selected_articles_screen/selected_article_screen.dart';
...
import 'package:gbs_new_project/GBSystem_X_Developpement/widgets/HOME_QUICK_ACCESS_WIDGETS/APP_BAR/app_bar_gestion_stock.dart';
                            ...
                            AiBarcodeScanner(
                              ...
                              onDetect: (p0) async {
                                try {
                                  ...
                                  await GBSystem_AuthService(context).affectuerArticleByTag(salarie: m.salarieGestionStockController.getCurrentSalarie!, site: m.siteGestionStockController.getCurrentSite!, tag: barcode).then(
                                    (value) {
                                      m.articlesController.setSelectedArticle = value;
                                      m.isLoading.value = false;
                                      Get.off(SelectedArticleScreen(
                                        updateUI: updateUI,
                                      ));
                                    },
                                  );
                      ...
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ArticleSalarieWidgetWhite(
                              btnText: GbsSystemStrings.str_retour,
                              onBtnTap: () async {
