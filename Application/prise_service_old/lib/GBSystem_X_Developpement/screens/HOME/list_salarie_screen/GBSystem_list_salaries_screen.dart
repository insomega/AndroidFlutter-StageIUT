...
import 'package:gbs_new_project/GBSystem_X_Developpement/screens/HOME/list_salarie_screen/GBSystem_list_salaries_controller.dart';
...
class GBSystemListSalariesScreen extends StatelessWidget {
  GBSystemListSalariesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    final GBSystemListSalariesController m =
        Get.put(GBSystemListSalariesController(context: context));
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical: 5),
                                        child: SalarieQuickAccessWidget(
                                            onNbr1Tap: () {
                                              callBool.value = true;
                                              phoneNumber = m
                                                  .usedListSalaries()[index]
                                                  .salarieModel
                                                  .SVR_TELPOR;

                                              print("nbr 1 $phoneNumber");
                                            },
                                            onNbr2Tap: () {
                                              callBool.value = true;
                                              phoneNumber = m
