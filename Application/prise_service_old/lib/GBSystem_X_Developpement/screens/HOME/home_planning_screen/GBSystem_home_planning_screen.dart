...
class GBSystemHomePlanningScreen extends StatefulWidget {
  ...
  @override
  State<GBSystemHomePlanningScreen> createState() =>
      _GBSystemHomePlanningScreenState();
}

class _GBSystemHomePlanningScreenState
    extends State<GBSystemHomePlanningScreen> {
  final GBSystemHomePlanningController m =
      Get.put(GBSystemHomePlanningController());
                              ...
                              showWarningSnackBar(context,
                                ...
                                try {
                                  ...
                                  GBSystem_ManageCatchErrors().catchErrors(
                                      ...
                                      message: e.toString(),
                                      method: "deconnexion",
                                      page: "GBSystem_home_planning_screen");
                                }
                                // Get.back();
                                // await m.deconnexion();
                              });
                          ...
                          children: [
                            sitePlanningController.getCurrentSite != null
                                ? GBSystem_Root_CardViewHome_Widget_Generique(
                                    title: GbsSystemStrings.str_site,
                                    onSearchTap: () {
                                      Get.to(const GBSystem_SelectItemScreen(
                                        type: GbsSystemStrings.str_type_site,
                                      ));
                                    },
                                    opt1: sitePlanningController
                                        .getCurrentSite?.LIE_LIB,
                                    opt2: sitePlanningController
                                        .getCurrentSite?.LIE_CODE,
                                    opt3: sitePlanningController
                                        .getCurrentSite?.VIL_LIB,
                                    opt4: sitePlanningController
                                        .getCurrentSite?.LIE_TLPH,
                                ...
                                : Container(
                                    ...
                                    child: Center(
                                      child: GBSystem_TextHelper().smallText(
                                          text: GbsSystemStrings.str_no_site),
                                    ),
                                  ),
                            SizedBox(
                              height:
                            ...
                            SizedBox(
                              ...
                              child: PageView(
                                ...
                                children: [
                                  salariePlanningController.getCurrentSalarie !=
                                          null
                                      ? Column(
                                          children: [
                                                ...
                                                onEnterTap: () async {
                                                  try {
                                                    ...
                                                    await GBSystem_AuthService(
                                                            context)
                                                        .pointageEntrerSorieSalarie(
                                                            Sens: "1",
                                                            salarie:
                                                                salariePlanningController
                                                                    .getCurrentSalarie!,
                                                            site: sitePlanningController
                                                                .getCurrentSite!)
                                                        .then((value) {
                                                      m.isloading.value = false;
                                                      if (value != null) {
                                                    ...
                                                    GBSystem_ManageCatchErrors()
                                                        .catchErrors(context,
                                                            message:
                                                                e.toString(),
                                                            method:
                                                                "pointageEntrerSorieSalarie2",
                                                            page:
                                                                "GBSystem_home_planning_screen");
                                                  }
                                                },
                                                title: GbsSystemStrings
                                                    .str_salarie,
                                                onSearchTap: () {
                                                  Get.to(
                            ...
                            Obx(
                              () => vacationController
                                              .getAllVacationsRx?.value !=
                                          null &&
                                      vacationController.getAllVacationsRx!
                                          .value!.isNotEmpty &&
                                      m.currentIndex.value.toInt() == 1
                                  ? Row(
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () async {
                                            await m
                                                .selectItemSiteFunction(context)
                                                .then(
                                              (value) {
                                                Get.to(
                                                    GBSystem_SelectItemVacationScreen(
                                                  destination:
                                                      GBSystemHomePlanningScreen(),
                                                ));
                                              },
                                            );
                                          },
