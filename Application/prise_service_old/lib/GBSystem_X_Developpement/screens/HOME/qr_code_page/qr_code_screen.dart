...
import 'package:gbs_new_project/GBSystem_X_Developpement/services/permission_handler_service.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "${GbsSystemStrings.str_qr_code} / ${GbsSystemStrings.str_bar_code}",
        ...
        child: Column(
          children: [
              ...
              children: [
                Expanded(
                  child: CustomButtonWithTrailling(
                      onTap: _shareFilePath.isNotEmpty
                          ...
                          : () {
                              showErrorDialog(context, GbsSystemStrings.str_vous_devez_sauvgarder_premiermenet);
                            },
                      horPadding: 15,
                      verPadding: 10,
                      // addBorder: true,
                      color: Colors.white,
                      text: GbsSystemStrings.str_share,
                ...
                Expanded(
                  child: CustomButtonWithTrailling(
                      ...
                      // addBorder: true,
                      color: Colors.white,
                      text: GbsSystemStrings.str_print,
                      textColor: Colors.black,
                      trailling: Icon(
            ...
            CustomButtonWithTrailling(
                ...
                // addBorder: true,
                color: Colors.white,
                text: GbsSystemStrings.str_save,
                textColor: Colors.black,
                trailling: Icon(
                  Icons.save,
                  color: GbsSystemServerStrings.str_primary_color,
    ...
    try {
      ...
      if (showSnackBar) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(isQrCode.value ? 'code QR bien enregistrer sur galerie' : 'code barre bien enregistrer sur galerie')),
        );
      }
      ...
      if (showSnackBar) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('quelque chose mal tourné !!!')),
        );
      }
    }
  }
              ...
              pw.Column(
                ...
                children: [
                  pw.Image(
                    ...
                    height: isQrCode ? 300 : 250,
                    width: isQrCode ? 300 : 500,
                    fit: pw.BoxFit.fill,
                  ),
