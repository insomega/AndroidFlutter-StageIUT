...
class GBSystemSelectItemEnterpotScreenController extends GetxController {
  GBSystemSelectItemEnterpotScreenController({
  ...
  RxList<GbsystemEnterpotModel> filtredEnterpot =
      RxList<GbsystemEnterpotModel>([]);
  ...
  void selectItemSiteFunction(
      {required GbsystemEnterpotModel selectedEntr}) async {
