...
class CatalogueController extends GetxController {
  ...
  Rx<GbsystemCatalogueModel?> _selectedCatalogue =
      Rx<GbsystemCatalogueModel?>(null);
  ...
  void updateCatalogue(
      GbsystemCatalogueModel catalogue, GbsystemCatalogueModel newCatalogue) {
  ...
  Rx<List<GbsystemCatalogueModel>?> get getAllCataloguesRx =>
      Rx(_allCatalogues);
}
