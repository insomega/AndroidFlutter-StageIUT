...
class GBSystem_Root_CardViewWidgetGenerique extends StatelessWidget {
  const GBSystem_Root_CardViewWidgetGenerique({
    super.key,
    required this.optStr1,
    required this.optStr2,
    required this.optStr3,
    required this.title,
    this.onTap,
    this.tileColor,
    this.circleColor,
    this.textCircleColor,
    this.showCircleBorder,
  });
        ...
        leading: CircleAvatar(
          ...
          child: CircleAvatar(
            ...
            child: GBSystem_TextHelper().normalText(
                ...
                textColor: textCircleColor ?? Colors.white),
          ),
        ),
        // trailing: Text(
        //   site.LIE_CODE,
...
class GBSystem_Root_CardView_SalarieGestionStockWidget extends StatelessWidget {
  const GBSystem_Root_CardView_SalarieGestionStockWidget({
    super.key,
    required this.salarie,
    this.onTap,
    this.tileColor,
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          leading: CircleAvatar(
            ...
            backgroundColor: Colors.blue,
            child: GBSystem_TextHelper()
                .normalText(text: "SAL", textColor: Colors.white),
          ),
          // trailing: Text(
          //   salarie.SVR_CODE,
          //   maxLines: 2,
...
class GBSystem_Root_CardView_VacationWidget extends StatelessWidget {
  ...
  final Color? tileColor;
  final void Function()? onTap, onEnterTap, onSortieTap, onCallTap, onLongPress;
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(
              "${ConvertDateService().parseTimeOfDayString(dateDynamic: vacation.HEURE_DEBUT)}-${ConvertDateService().parseTimeOfDayString(dateDynamic: vacation.HEURE_FIN)}",
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
            ),
            SizedBox(
              ...
              child: Row(
                children: [
                  ButtonEntrerSortieWithIconAndText(
                    onTap: onEnterTap,
                    disableBtn: vacation.PNTGS_IN_NBR != null &&
                        vacation.PNTGS_IN_NBR!.isNotEmpty,
                    number: vacation.PNTGS_IN_NBR != null &&
                            vacation.PNTGS_IN_NBR!.isNotEmpty
                        ? int.parse(vacation.PNTGS_IN_NBR!)
                        : null,
                    icon: const Icon(
                    ...
                    width: 80,
                    verPadd: GBSystem_ScreenHelper.screenWidthPercentage(
                        context, 0.02),
                    horPadd: GBSystem_ScreenHelper.screenWidthPercentage(
                        context, 0.01),
                  ...
                  ButtonEntrerSortieWithIconAndText(
                    disableBtn: vacation.PNTGS_OUT_NBR != null &&
                        vacation.PNTGS_OUT_NBR!.isNotEmpty,
                    number: vacation.PNTGS_OUT_NBR != null &&
                            vacation.PNTGS_OUT_NBR!.isNotEmpty
                        ? int.parse(vacation.PNTGS_OUT_NBR!)
                        : null,
                    onTap: onSortieTap,
                    width: 80,
                    icon: const Icon(
        ...
        leading: Container(
          decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: getColorCircleAvatar(vacation),
          ...
          child: CircleAvatar(
            ...
            child: isSelected
                ...
                : GBSystem_TextHelper()
                    .normalText(text: "VAC", textColor: Colors.white),
          ),
        ),
        trailing: InkWell(
          onTap: onCallTap,
  ...
  List<Color> getColorCircleAvatar(VacationModel vacation) {
    if (vacation.PNTGS_IN_NBR != null &&
        vacation.PNTGS_IN_NBR!.isNotEmpty &&
        vacation.PNTGS_OUT_NBR != null &&
        vacation.PNTGS_OUT_NBR!.isNotEmpty) {
      return [Colors.green, Colors.red];
    } else if ((vacation.PNTGS_IN_NBR == null ||
            vacation.PNTGS_IN_NBR!.isEmpty) &&
        (vacation.PNTGS_OUT_NBR != null &&
            vacation.PNTGS_OUT_NBR!.isNotEmpty)) {
      return [Colors.red, Colors.red];
    } else if ((vacation.PNTGS_OUT_NBR == null ||
            vacation.PNTGS_OUT_NBR!.isEmpty) &&
        vacation.PNTGS_IN_NBR != null &&
        vacation.PNTGS_IN_NBR!.isNotEmpty) {
