    ...
    return InkWell(
      onTap: () async {
        DateTime? newDate = await showDatePicker(
          ...
          locale: Locale('fr'),
          helpText: GbsSystemStrings.str_datePickerHelpText,
          cancelText: GbsSystemStrings.str_cancel,
          confirmText: GbsSystemStrings.str_done,
          errorFormatText: GbsSystemStrings.str_datePickerInputHint,
          errorInvalidText: GbsSystemStrings.str_datePickerInputHint,
          fieldHintText: GbsSystemStrings.str_datePickerInputHint,
          fieldLabelText: GbsSystemStrings.str_datePickerHelpText,
        );
        setState(() {
          if (newDate != null) {
            date = newDate;
...
class _CustomTimePickerFrenchState extends State<CustomTimePickerFrench> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final TimeOfDay? picked = await showTimePicker(
      context: context,
      initialTime: widget.selectedDate ?? TimeOfDay.now(),
      helpText: GbsSystemStrings.str_datePickerHelpText,
      cancelText: GbsSystemStrings.str_cancel,
      confirmText: GbsSystemStrings.str_done,
      errorInvalidText: GbsSystemStrings.str_datePickerInputHint,
