              ...
              children: [
                Row(
                  children: [
                    ...
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTCAT_LIB,
                      textColor: Colors.white,
                    ),
                  ],
                ),
                Row(
                  ...
                  children: [
                    ...
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTREF_CODE,
                      textColor: Colors.white,
                    ),
                  ],
                ),
                Row(
                  ...
                  children: [
                    SizedBox(
                      width: 90,
                      child: GBSystem_TextHelper().smallText(
                          text: 'Libellé article : ',
                          textColor: Colors.white,
                          fontWeight: FontWeight.bold),
                    ),
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTREF_LIB,
                      textColor: Colors.white,
                    ),
                  ],
                ),
                Row(
                  ...
                  children: [
                    ...
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTFOUREF_PRIX,
                      textColor: Colors.white,
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTFOUREF_START_DATE != null
                          ? ConvertDateService().parseDate(
                              date: catalogueModel.ARTFOUREF_START_DATE!)
                          : "",
                      textColor: Colors.white,
                    ),
                  ],
                ...
                Row(
                  ...
                  children: [
                    ...
                    GBSystem_TextHelper().smallText(
                      text: catalogueModel.ARTFOUREF_END_DATE != null
                          ? ConvertDateService().parseDate(
                              date: catalogueModel.ARTFOUREF_END_DATE!)
                          : "",
                      textColor: Colors.white,
                    ),
                  ],
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: GBSystem_TextHelper().smallText(
                                text: GbsSystemStrings.str_delete,
                                textColor: Colors.white,
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: GBSystem_TextHelper().smallText(
                                text: GbsSystemStrings.str_update,
                                textColor: Colors.white,
                                fontWeight: FontWeight.w500),
                          ),
                        ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: GBSystem_TextHelper().smallText(
                          text: GbsSystemStrings.str_add_stock,
                          textColor: Colors.white,
                          fontWeight: FontWeight.w500),
                    ),
                  ),
