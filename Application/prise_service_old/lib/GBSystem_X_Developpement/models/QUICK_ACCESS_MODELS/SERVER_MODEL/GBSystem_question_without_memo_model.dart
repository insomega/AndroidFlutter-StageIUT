...
class QuestionWithoutMemoModel {
  String LIEINSPSVRQU_UIDF;
  String LIEINSPSVRQU_IDF;
  String LIEINSPSVRQU_NOTE;
  String LIEINSPSVRQU_ACTION_LONG;
  String LIEINSPSVRQU_ACTION_SHORT;
  String? LIEINSPSVRQU_MEMO;
  String LIEINSPSVRQU_STATUT;
  String? LIEINSQMMO_IDF_ALONG;
  String? LIEINSQMMO_IDF_ASHORT;
  DateTime? LIEINSPSVRQU_ALONG_DATE;
  String LIEINSPSVR_IDF;
  DateTime? LIEINSPSVR_START_DATE;
  ...
  String LIEINSPQU_CODE;
  String LIEINSPQU_LIB;
  String LIEINSPQU_MAX;
  String LIEINSPQU_ORDER_NUM;
  String LIEINSPQU_NOTATION_TYPE;
  String? LIEINSPEVAL_COLOR;
  String LIEINSPCAT_IDF;
  String LIEINSPCAT_CODE;
  String LIEINSPCAT_LIB;
  String LIEINSPCAT_COEF;
  String? LIEINSPCAT_CLR;
  String? LIEINSPQU_HELP;
  String NBR_PHOTO;
  DateTime? LIEINSPSVRQU_CLOSED_DATE;
  ...
  static QuestionWithoutMemoModel fromJson(json) {
    DateTime? LIEINSPSVRQU_ALONG_DATE,
    ...
    return QuestionWithoutMemoModel(
  ...
  static List<QuestionWithoutMemoModel>
      convertDynamictoListQuestionsWithoutMemo(List<dynamic> qstDynamic) {
    List<QuestionWithoutMemoModel> listQst = [];
    for (var i = 0; i < qstDynamic.length; i++) {
      listQst.add(QuestionWithoutMemoModel.fromJson(qstDynamic[i]));
    }
    return listQst;
  }
}
