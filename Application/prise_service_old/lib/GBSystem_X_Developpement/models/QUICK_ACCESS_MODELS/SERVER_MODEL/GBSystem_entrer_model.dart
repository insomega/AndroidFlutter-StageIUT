...
class EntrerModel {
  ...
  static EntrerModel fromJson(json) {
...
TimeOfDay heureFin =  TimeOfDay(hour: hoursFin, minute: minutesFin);
  ...
  static List<EntrerModel> convertDynamictoListEnter(
      List<dynamic> entrerDynamic) {
    List<EntrerModel> listEntrer = [];
    for (var i = 0; i < entrerDynamic.length; i++) {
      listEntrer.add(EntrerModel.fromJson(entrerDynamic[i]));
    }
    return listEntrer;
  }
}
