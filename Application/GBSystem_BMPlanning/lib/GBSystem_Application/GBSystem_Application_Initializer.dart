...
class GBSystem_BMPlanning_Initializer extends GBSystem_AppInitializer {
  GBSystem_BMPlanning_Initializer() {
    // TODO: implement
  }
  ...
  static Future<bool> initialize() async {
    ...
    GBSystem_Application_Params_Manager.initialize(GBSystem_BMPlanning_Application_Params());
