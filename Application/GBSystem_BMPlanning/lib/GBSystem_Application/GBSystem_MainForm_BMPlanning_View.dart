...
import 'GBSystem_MainForm_BMPlanning_Controller.dart';
...
class GBSystem_MainForm_BMPlanning_View extends GBSystem_Root_MainForm_View<GBSystem_MainForm_BMPlanning_Controller> {
  GBSystem_MainForm_BMPlanning_View({Key? key}) : super(key: key);

  @override
  final controller = Get.put(GBSystem_MainForm_BMPlanning_Controller());
...
// class GBSystem_MainForm_BMPlanning_View extends GetView<GBSystem_MainForm_BMPlanning_Controller> {
//   @override
