...
class GBSystem_PS2_Initializer extends GBSystem_AppInitializer {
  GBSystem_PS2_Initializer() {
    // TODO: implement
  }
  ...
  static Future<bool> initialize() async {
    ...
    GBSystem_Application_Params_Manager.initialize(GBSystem_PS2_Application_Params());
