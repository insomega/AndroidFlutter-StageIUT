                                      ...
                                      AiBarcodeScanner(
                                        ...
                                        onDetect: (p0) async {
                                          ...
                                          try {
                                            ...
                                            await m.getArticleByTag(tagType: p0.barcodes.first.format == BarcodeFormat.qrCode ? "2" : "3", tag: barcode).then((value) async {
                                                                                            if (value != null) {
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: CatalogueWidget(
                                    onDeleteTap: () async {
                                      showWarningSnackBar(
                                        GBSystem_Application_Strings.str_supprission_question.tr,
                                        btnOkOnPress: () {},
                                        // () async {
                                        //   m.isLoadingMain.value = true;
                                        ...
                                        //       showSuccesDialog(GBSystem_Application_Strings.str_operation_effectuer.tr);
                                        //     }
                                        //   });
                                        // }
                                      );
