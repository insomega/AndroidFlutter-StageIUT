import 'package:gbsystem_stock/GBSystem_Application/GBSystem_MainForm_Stock_Bindng.dart';
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_MainForm_Stock_View.dart';
import 'package:gbsystem_stock/GBSystem_Application/GBSystem_home_gestion_stock_Bonding.dart';
...
class GBSystem_Application_Pages {
  static final pages = [
    ...
    GetPage(name: GBSystem_Application_Routes.mainAppView, page: () => GBSystem_MainForm_Stock_View(), binding: GBSystem_MainForm_Stock_Binding()),
    GetPage(name: GBSystem_Application_Routes.homeGestionStock, page: () => const GBSystemHomeGestionStockScreen(), binding: GBSystemHomeGestionStockBinding()),
  ];
}
