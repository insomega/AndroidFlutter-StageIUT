...
class GBSystem_MainForm_Stock_View extends GBSystem_Root_MainForm_View<GBSystem_MainForm_Stock_Controller> {
  ...
  void _navigateToGestionStock() {
    ...
    Get.toNamed(GBSystem_Application_Routes.homeGestionStock);
  }
  ...
  @override
  bool get shouldBlur => false; //Get.put(GBSystem_Vacation_List_PS2_Controller()).callBool.value;

  // @override
  // Widget? buildOverlay(BuildContext context) {
  //   final subController = Get.put(GBSystem_Vacation_List_PS2_Controller());
  //   return Obx(() {
