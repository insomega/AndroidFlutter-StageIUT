...
class GBSystemSalarieGestionStockController extends GetxController {
  ...
  Rx<SalarieGestionStockModel?>? _currentSalarie = Rx<SalarieGestionStockModel?>(null);
  Rx<SalarieGestionStockModel?>? _currentSelectedSalarie = Rx<SalarieGestionStockModel?>(null);
  ...
  set setAllSelectedSalarie(List<SalarieGestionStockModel>? ListSelectedSalarie) {
  ...
  set setCurrentSelectedSalarieSalarie(SalarieGestionStockModel? SelectedSalarie) {
  ...
  List<SalarieGestionStockModel>? get getAllSelectedSalaries => _allSelectedSalaries;
  SalarieGestionStockModel? get getCurrentSelectedSalarie => _currentSelectedSalarie?.value;
  Rx<SalarieGestionStockModel?>? get getCurrentSelectedSalarieRx => _currentSelectedSalarie;
}
