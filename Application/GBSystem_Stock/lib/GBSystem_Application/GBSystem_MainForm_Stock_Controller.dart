...
// import 'package:bmsoft_Stock/GBSystem_Application/GBSystem_FilterBottomSheet.dart';
// import 'package:flutter/material.dart';
...
class GBSystem_MainForm_Stock_Controller extends GBSystem_Root_MainForm_Controller {
  ...
  Future<void> loadArticlesRef() async {
    isLoading.value = true;
    try {
      isLoading.value = true;

      // final articlesRef = await GBSystem_AuthService(context).getAllArticlesRef();
      final Null articlesRef = null;
      //if (articlesRef != null)
      {
        articlesController.setAllArticles = articlesRef;
        // Implémentation existante pour set les articles
      }
      isLoading.value = false;
    } catch (e) {
      GBSystem_Add_LogEvent(message: e.toString(), method: "GBSystem_SelectItemArticleScreen", page: "choose_mode_stock_screen");
    } finally {
      isLoading.value = false;
    }
  }
  ...
  //   try {} catch (e) {
  //     GBSystem_Add_LogEvent(message: e.toString(), method: "_initializeData_For_First_VAcation", page: "GBSystem_MainForm_Stock_Controller");
  //   }
  // }
  ...
  Future<void> _initializeData() async {
    try {
      ...
      GBSystem_Add_LogEvent(message: e.toString(), method: "_initializeData", page: "GBSystem_MainForm_Stock_Controller");
    } finally {
