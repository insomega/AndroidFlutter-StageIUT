...
class GBSystem_Vacation_Informations_Controller extends GBSystem_Root_Controller {
  ...
  Future<PauseModel?> updatePauseVacation({required GBSystem_Vacation_Model vacation, required TimeOfDay debutPause, required TimeOfDay finPause}) async {
    ...
    if ((ServerDataREponse.data["Data"] as List).isNotEmpty && (ServerDataREponse.data["Errors"] as List).isEmpty) {
      ...
      String VAC_BREAKSTART_HOUR = vacation.VAC_BREAKSTART_HOUR.toString(); //      ServerDataREponse.getFirstElementFromDataList()["VAC_BREAKSTART_HOUR"];
      String VAC_BREAKEND_HOUR = vacation.VAC_BREAKEND_HOUR.toString(); //ServerDataREponse.getFirstElementFromDataList()["VAC_BREAKEND_HOUR"];
      String VAC_DURATION = vacation.VAC_DURATION.toString(); //ServerDataREponse.getFirstElementFromDataList()["VAC_DURATION_STR"];
      String VAC_BREAK = vacation.VAC_BREAK.toString(); //ServerDataREponse.getFirstElementFromDataList()["VAC_BREAK_STR"];
