...
// Ces valeurs sont utilisées comme références pour adapter les tailles de police, icônes et padding
// en fonction de la largeur de l'écran. Elles sont copiées depuis un autre fichier
// (prise_service_mobile.dart) pour assurer l'autonomie de ce fichier d'aide.
...
///
/// Gère les durées positives et négatives.
/// Par exemple, une durée de 90 minutes sera formatée en "+01h30 min", et -30 minutes en "-00h30 min".
///
/// [duration]: L'objet `Duration` à formater.
/// Retourne une chaîne de caractères représentant la durée.
String formatDuration(Duration duration) {
  ...
  // Fonction locale utilitaire pour formater un nombre en deux chiffres, en ajoutant un zéro si nécessaire.
