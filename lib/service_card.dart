          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(service.clientInfo, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                  Text(service.clientName, style: TextStyle(color: Colors.grey[700], fontSize: 13)),
