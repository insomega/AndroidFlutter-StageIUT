...
import '../core/service.dart'; // Importe la définition de la classe `Service` depuis le chemin `models/service.dart`. Cette classe représente la structure des données pour un service.
