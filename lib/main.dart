...
// C'est le point de départ de l'exécution de l'application Flutter.
void main() async {
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({super.key}); // `super.key` est passé au constructeur du parent `StatelessWidget`.

  // La méthode `build` décrit la partie de l'interface utilisateur représentée par ce widget.
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Prise de services automatique', // Le titre de l'application affiché dans le gestionnaire de tâches.
      debugShowCheckedModeBanner: false, // Défini à `false` pour masquer le bandeau "DEBUG" en haut à droite de l'application.
      ...
      // Délégats de localisation pour supporter différentes langues et formats.
