...
class CustomTimePickerFrench extends StatefulWidget {
  ...
  final bool enabled;
  CustomTimePickerFrench({super.key, this.initialDate, required this.onDateSelected, this.width, this.labelText, this.color, required this.selectedDate, this.enabled = false});
...
class CustomDatePickerFrench extends StatefulWidget {
  ...
  final bool enabled;
  CustomDatePickerFrench({super.key, this.initialDate, required this.onDateSelected, this.width, this.labelText, this.color, required this.selectedDate, this.enabled = false});
