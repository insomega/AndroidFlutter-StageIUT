...
class GBSystem_Serveur_Info_Photo_Model extends GBSystem_Root_DataModel {
  ...
  factory GBSystem_Serveur_Info_Photo_Model.fromJson(Map<String, dynamic> json) {
    GBSystem_Serveur_Info_Model serveurInfo = GBSystem_Serveur_Info_Model.fromJson(json);
    return GBSystem_Serveur_Info_Photo_Model(Serveur_Info: serveurInfo, imageSalarie: null);
  }
