...
class GBSystem_System_Strings {
  //Amar--------------------------------------------
  static const okey_ChangePassword = "B1D8D4F9B49A412FBD91B42B1EC5CA7D";
  //------------------------------------------------

  // logo && name
  static const str_logo_image_path = "assets/images/logo.png";
  static const str_veste_image_path = "assets/images/veste.jpg";
  static const str_vetments_image_path = "assets/images/vetements.jpg";

  static const str_chaussure_image_path = "assets/images/chaussure.jpg";
  static const str_pantalon_image_path = "assets/images/pantalon.jpg";
  static const str_jupe_image_path = "assets/images/jupe.jpg";
  //Colors
  ...
  static const str_error_no_connection_lottie_path = "assets/lotties/noConnection.json";
  ...
  static const String no_data_lottie_path = "assets/lotties/noDataLastLottie.json";
  ...
  static const String CNX_TYPE_Server_gestion_stock = "server";

  static const String CNX_TYPE_Planner = "planner";

  static const String bmServer_PriseService = "BMSVR-MBLN-PS";
  // "BMSERVER";
  static const String bmServer_gestion_stock = 'BMSTOCK-MBLN';
  static const String bmPlanning_Mobile = 'BMPlanning-MBLN';
  static const String bmEvents_Mobile = 'BMEvents-MBLN';
  ...
  static const String quick_Access_PriseService = "bmplanning-qcs-MBLN";
  static const String gestion_stock_PriseService = "bmarticles";
  static const bool kIsWeb = bool.fromEnvironment('dart.library.js_util');
  static const String kEntrepriseName = "clientName";
  //static const str_server_url = "https://www.bmplanning.com/BMServerR.dll/BMRest";
  ...
  static const String kDOS_IDF = "DOS_IDF";
  static const String kDOS_CODE = "DOS_CODE";
  static const String kToken = "token";
  static const String kCookies = "cookies";
  static const String kB5512 = "B5512";
  ...
  static const String kHiveBox_Requests = 'offline_requests';
  static const String kHiveBox_Evaluation = 'evaluation_status';

  // static const String kClientNumber = String.fromEnvironment('CLIENT_NUMBER', defaultValue: "0");
  // static String kMyBaseUrlStandard = String.fromEnvironment('API_URL', defaultValue: "");

  // static String kMyS19Standard = String.fromEnvironment('S19', defaultValue: "");
  ...
  // "");
  // static const String kMyAppName = String.fromEnvironment('APP_NAME', defaultValue: "BmSalarié-M");
