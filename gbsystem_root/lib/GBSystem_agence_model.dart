...
class GbsystemAgenceModel {
  ...
  static GbsystemAgenceModel fromJson(json) {
    ...
    if (json["DOS_CLOSEDPLNG"].toString().isNotEmpty) {
      DOS_CLOSEDPLNG = DateFormat(detecteDateFormat(json["DOS_CLOSEDPLNG"]))
    ...
    if (json["USRDOS_END_DATE"].toString().isNotEmpty) {
      USRDOS_END_DATE = DateFormat(detecteDateFormat(json["USRDOS_END_DATE"]))
          .parse(json["USRDOS_END_DATE"]);
    }

    return GbsystemAgenceModel(
      DOS_CLOSEDPLNG: DOS_CLOSEDPLNG,
      USRDOS_END_DATE: USRDOS_END_DATE,
      USRDOS_START_DATE: USRDOS_START_DATE,
