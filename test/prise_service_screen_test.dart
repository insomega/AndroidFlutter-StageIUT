...
class MockResponsiveUtils {
  // Méthode mock pour le padding responsive. Retourne la valeur de base.
  static double responsivePadding(BuildContext context, double value) => value;
  // Méthode mock pour la taille d'icône responsive. Retourne la valeur de base.
  static double responsiveIconSize(BuildContext context, double value) => value;
  // Méthode mock pour la taille de police responsive. Retourne la valeur de base.
...
class TimeDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column( // Organise le contenu de la carte en colonne.
        children: [
          ...
          Row( // Range les boutons d'action en ligne.
            ...
            children: [
              ...
              if (type == TimeCardType.result)
                ElevatedButton(
                  ...
                  child: Row( // Le bouton contient une icône et du texte.
                    children: [
...
class _MockMyHomePageState extends State<MockMyHomePage> {
  // Déclare l'état interne du widget `_MockMyHomePageState`.
  ...
  // Prend une date, le nombre de mois à ajouter/retirer, et un callback pour mettre à jour la date.
  ...
  // Prend une date, le nombre de jours à ajouter/retirer, et un callback pour mettre à jour la date.
  ...
  // Fonctions de rappel factices pour les interactions avec les services.
  // Elles simulent les handlers réels de `PriseServiceScreen`.
  ...
  void _scrollToService(Service service) {} // Méthode factice pour le défilement vers un service spécifique.
      ...
      home: Builder(
        builder: (context) {
          ...
          return Scaffold(
            ...
            body: Column( // Le corps de l'écran est organisé en une colonne.
              children: [
  ...
  AppBar _buildAppBar(BuildContext context) {
    ...
    if (_dataLoaded) {
      ...
      importButton = ElevatedButton.icon(
        ...
        label: FittedBox( // Ajuste le texte pour qu'il tienne dans l'espace.
    ...
    if (orientation == Orientation.portrait) {
      return AppBar(
        ...
        leading: Padding( // Widget placé au début de l'AppBar (généralement une icône ou un logo).
          padding: EdgeInsets.all(MockResponsiveUtils.responsivePadding(context, 4.0)), // Espacement interne.
          child: Image.asset( // Image du logo de l'application.
            'assets/logo_app.png',
        ...
        bottom: PreferredSize( // Widget en bas de l'AppBar, utile pour des barres supplémentaires.
          preferredSize: Size.fromHeight(MockResponsiveUtils.responsivePadding(context, 45.0)), // Hauteur préférée.
          child: Container( // Conteneur pour les boutons d'import/export.
            ...
            child: Row( // Les boutons sont organisés en ligne.
      ...
      return AppBar(
        ...
        actions: [ // Actions (boutons) sur le côté droit de l'AppBar.
  ...
  Widget _buildDateRangeSelector() {
    ...
    Widget buildColumnToggleButton(String label, bool isVisible, ValueChanged<bool> onChanged) {
      return Padding(
        ...
        child: InkWell( // Permet de rendre la zone cliquable avec un effet d'ondulation.
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(MockResponsiveUtils.responsivePadding(context, 8.0)),
              boxShadow: isVisible ? [ // Ombre si le bouton est "visible" (actif).
                BoxShadow(
            ...
            child: Row( // Contenu du bouton (icône et texte).
    ...
    Widget dateControls = Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        IconButton( // Bouton flèche gauche pour reculer d'un mois.
        ...
        Expanded(
          child: _buildDateControl( // Contrôle de la date de début.
            _startDate,
        ...
        Container( // Séparateur visuel vertical.
        ...
        SizedBox(width: MockResponsiveUtils.responsivePadding(context, 4.0)), // Espace.
        Expanded(
          child: _buildDateControl( // Contrôle de la date de fin.
            _endDate,
            (newDate) => _endDate = newDate,
            const Key('endDateText'), // Clé pour le texte de la date de fin.
          ),
        ),
        IconButton( // Bouton flèche droite pour avancer d'un mois.
    ...
    Widget columnToggleButtons = Row(
      ...
      children: [
        buildColumnToggleButton('D', _showDebutColumn, (newStatus) { // Bouton "Début".
          _showDebutColumn = newStatus;
        }),
        buildColumnToggleButton('F', _showFinColumn, (newStatus) { // Bouton "Fin".
          _showFinColumn = newStatus;
        }),
        buildColumnToggleButton('R', _showResultColumn, (newStatus) { // Bouton "Résultat".
    ...
    return Container(
      ...
      child: orientation == Orientation.portrait
          ? Column( // En mode portrait, les contrôles de date et les bascules sont en colonne.
              ...
              children: [
                ...
                Row( // Ligne pour la date actuelle et les boutons de bascule.
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded( // Le texte de la date actuelle prend l'espace disponible.
                      child: Text(
          ...
          : Row( // En mode paysage, tous les éléments sont sur une seule ligne.
              children: [
                Expanded(
                ...
                SizedBox(width: MockResponsiveUtils.responsivePadding(context, 10.0)), // Espace horizontal.
                Expanded( // Les boutons de bascule des colonnes sont également dans un Expanded.
  ...
  Widget _buildDateControl(DateTime date, ValueChanged<DateTime> onDateChanged, Key dateTextKey, {Key? rowKey}) {
    return Row(
      ...
      children: [
        IconButton( // Bouton pour réduire le jour de 1.
          ...
          visualDensity: VisualDensity.compact,
          padding: EdgeInsets.zero,
          constraints: BoxConstraints.tightFor( // Contraintes de taille strictes pour l'icône.
            width: MockResponsiveUtils.responsiveIconSize(context, 16.0),
            height: MockResponsiveUtils.responsiveIconSize(context, 16.0),
          ),
        ),
        Expanded( // Le `GestureDetector` contenant le texte de la date prend l'espace restant.
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: FittedBox( // Ajuste le texte de la date pour qu'il tienne dans le conteneur.
                fit: BoxFit.scaleDown,
                child: Text(
        ...
        IconButton( // Bouton pour augmenter le jour de 1.
  ...
  Widget _buildSearchBar() {
    return Padding(
      ...
      child: TextField( // Champ de texte pour la recherche.
  ...
  Widget _buildColumnHeaders() {
    return Padding(
      ...
      child: Row( // Les en-têtes sont disposés en ligne.
        children: [
  ...
  Widget _buildFooter() {
    return Padding(
      ...
      child: Row( // Contient le texte du copyright et de la date.
        mainAxisAlignment: MainAxisAlignment.center, // Centre le contenu.
        children: [
          Flexible( // Permet au texte de s'adapter si l'espace est limité.
            child: Text(
    ...
    testWidgets('TimeDetailCard displays service information', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(
            body: TimeDetailCard( // Le widget `TimeDetailCard` à tester.
              service: service,
