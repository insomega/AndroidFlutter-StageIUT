...
import '../stageS4/lib/utils/responsive_utils.dart' as mobile_responsive; // Importe le fichier des utilitaires responsives. On le renomme `mobile_responsive` pour éviter les conflits de noms et améliorer la clarté dans les tests.
